...
var historico = "",historicoFinal = "";

//Aqui é lançado o historico
...
if(historico == ""){
    ...
    historico = historico + result.value;
}

    //aqui é realizado o calculo
    if(result.value.includes("0/") || result.value.includes("/0")){
     ...
     historicoFinal = historico + " = " +  result.value + "/n";

     document.getElementById('historico').value = historicoFinal.replace("/n"," || ");
